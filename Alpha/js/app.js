(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".top-page__slider")) new swiper_core_Swiper(".top-page__slider", {
            ...
            if (document.querySelector(".slider-small__slider")) new swiper_core_Swiper(".slider-small__slider", {
